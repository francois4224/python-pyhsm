...
class YHSM_WrongInputSize(YHSM_Error):
    ...
    def __init__(self, name, expected, size):
        reason = "Bad size of argument '%s', expected %i got %i" % (
            name,
            expected,
            size,
        )
...
class YHSM_InputTooShort(YHSM_Error):
    ...
    def __init__(self, name, expected, size):
        reason = "Argument '%s' too short, expected min %i got %i" % (
            name,
            expected,
            size,
        )
...
class YHSM_InputTooLong(YHSM_Error):
    ...
    def __init__(self, name, expected, size):
        reason = "Argument '%s' too long, expected max %i got %i" % (
            name,
            expected,
            size,
        )
...
class YHSM_WrongInputType(YHSM_Error):
    ...
    def __init__(self, name, expected, name_type):
        reason = "Bad type of argument '%s', expected %s got %s" % (
            name,
            expected,
            name_type,
        )
